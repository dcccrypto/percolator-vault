//! Percolator LP Vault
//!
//! Standalone Solana program that manages LP vaults for Percolator perpetual markets.
//! Supports two pool modes:
//!   - **Insurance LP** (mode 0): LPs provide insurance backing for the market
//!   - **Trading LP** (mode 1): LPs earn trading fees via share appreciation
//!
...
//!
//! Instructions:
//!   0 - InitPool:                Create insurance LP pool for a slab
